...
function EachUser({ user, setSelectedUser, selectedUser }) {
  ...
  ), Time = (_b = (_a = user == null ? void 0 : user.text) == null ? void 0 : _a.at(0)) == null ? void 0 : _b.modified_on, time_ago = timeAgo(Time);

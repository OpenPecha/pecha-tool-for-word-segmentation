...
var tailwind_default = "/build/_assets/tailwind-D5SYXRDJ.css";
    ...
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("h4", { className: " font-bold text-sm", children: [
            text.version,
            " ",
...
var getAllUniqueBatches = async (category) => {
  ...
  }), uniqueVersionCategories = /* @__PURE__ */ new Map(), versionCount = {};
  for (let record of textRecords) {
    ...
    versionCount[version] ? versionCount[version]++ : versionCount[version] = 1;
  }

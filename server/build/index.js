...
var AboutUser = ({ selectedUser }) => {
  ...
  return console.log(...oo_oo("b24b89d3_0", selectedUser)), annotator ? /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "sticky top-[80px]  rounded-sm border border-stroke bg-white px-5 pt-6 pb-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-10 ", children: [

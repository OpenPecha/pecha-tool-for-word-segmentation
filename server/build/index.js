...
var AboutUser = ({ selectedUser }) => {
  ...
  return annotator ? /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "sticky top-[80px]  rounded-sm border border-stroke bg-white px-5 pt-6 pb-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-10 ", children: [
    ...
    lineNumber: 38,
    columnNumber: 5
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "font-bold", children: "Select a User please" }, void 0, !1, {
    fileName: "app/components/admin/AboutUser.tsx",
    lineNumber: 35,
    columnNumber: 26
  }, this);
...
var import_react24 = require("@remix-run/react"), import_react25 = require("react"), import_jsx_dev_runtime20 = require("react/jsx-dev-runtime"), UserListCard = ({
  setSelectedUser,
  selectedUser
}) => {
  let { users, groups, user, reviewers } = (0, import_react24.useLoaderData)(), handleSelection = (value) => {
    console.log(...oo_oo("e26093f3_0", value)), setSelectedUser(value);
  ...
  ).sort((a, b) => a.reviewer_id === null && b.reviewer_id !== null ? 1 : a.reviewer_id !== null && b.reviewer_id === null ? -1 : 0)), /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4", children: [
...
var import_react31 = require("react"), import_jsx_dev_runtime23 = require("react/jsx-dev-runtime");
function useModal() {

...
var tailwind_default = "/build/_assets/tailwind-SAZNE67P.css";
...
function admin() {
  let { user, users } = (0, import_react17.useLoaderData)(), [search, setSearch] = (0, import_react18.useState)("");
  users = users.sort(
